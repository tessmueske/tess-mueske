...
function About() {
  ...
  return (
    <div className="about-container">
        ...
        <p>now i'm a full-stack developer, learning spanish and drinking wine in madrid. i'm seeking a full-time software development role in madrid, new york city, or other major world cities. </p>
        <p>
