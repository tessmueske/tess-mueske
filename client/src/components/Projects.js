...
function Projects(){
    return (
        <div className="project-container">
            ...
            <p>i have experience with javascript, react, html, css, python, flask, sqlalchemy, and render for cloud deployment. i've worked with orms, full crud, restful routing, json-based data structures, and flask apis. i also have experience with formik for form validations on the frontend, bcrypt for password hashing, flask mail extension for account verification, and formspree integration for contact forms.</p>
