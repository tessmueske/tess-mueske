...
function App() {
  return (
    ...
    <div className="center-container">
      ...
      <p>crimson fills a gap in the menstruation tracking app space. the apps on the market use gendered language, either for bodies or for products. this project does not.
